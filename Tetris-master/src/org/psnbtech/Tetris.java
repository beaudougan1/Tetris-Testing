...
public class Tetris extends JFrame {
	 ...
	 */
	public BoardPanel board; //CHANGED TO PUBLIC
	 ...
	 */
	public TileType currentType; //CHANGED TO PUBLIC
	 ...
	 */ //CHANGED TO PUBLIC TO TEST ROTATE PIECE
...
//CHANGED TETRIS TO PUBLIC
	...
	private void updateGame() {
		...
		if(board.isValidAndEmpty(currentType, currentCol, currentRow + 1, currentRotation)) {
			...
			if(cleared > 0) {
				score += 50 << cleared;//"<< cleared" should not be there
			}
